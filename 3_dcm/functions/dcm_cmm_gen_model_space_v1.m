function [DCMa] = dcm_cmm_gen_model_space_v1()

% Generates the alternate model structures
%==========================================================================
...
for da=1:3 % create A matrices of first 3 models
    ...
    %these models have no intrinsic or input to parietal
        ...
        DCMa{da}.A{3} = zeros(Nareas,Nareas);    % lateral connections/A{3} binary constraints on extrinsic connections
